...
import DataTable from '../../component/DataTables/DataTables'
    ...
    return (
      <Tabs tabBarStyle={{padding: '0 20px'}} defaultActiveKey="1" onChange={null}>
        <TabPane className="tab-pane" tab="课程信息" key='1'>
          ...
          <DataTable currentLessonsList={currentLessonsList} historyLessonsList={historyLessonsList} entities={entities} />
        </TabPane>
