...
function Power(state = {
  ...
  entities: {
    0: {
      id: 0, nick: '爱奇迪集团', key: '0', children: [1], data: [1001]
    },
    1: {
      id: 1, nick: '广州分公司', key: '1', children: [2, 3, 4, 5], data: [1002]
    },
    2: {
      id: 2, nick: '总经办', key: '2', data: [1001]
    },
    3: {
      id: 3, nick: '财务部', key: '3', data: [1002]
    },
    4: {
      id: 4, nick: '工程部', key: '4', data: [1003]
    },
    5: {
      id: 5, nick: '产品研发部', key: '5', children: [6, 7, 8], data: [1001]
    },
    6: {
      id: 6, nick: '开发一组', key: '6', data: [1001, 1002]
    },
    7: {
      id: 7, nick: '开发二组', key: '7', data: [1001, 1003]
    },
    8: {
      id: 8, nick: '测试组', key: '8', data: [1002, 1003]
    }
  },
  result: 0,
  showimg: 0
...
function data(
  state = {
    1001: {
      id: 1001, name: '白帆', mid: 1001, isselect: false, color: 'white'
    },
    1002: {
      id: 1002, name: '王鹏', mid: 1002, isselect: false, color: 'white'
    },
    1003: {
      id: 1003, name: '王鹏2', mid: 1003, isselect: false, color: 'white'
    },
    sure: false,
    a: [], // 右边的数组
    b: [], // 左边渲染的数组
